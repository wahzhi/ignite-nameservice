...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
   ...
   * @request GET:/nameservice/nameservice/params
   */
   ...
   * @request GET:/nameservice/nameservice/whois
   */
  queryWhoisAll = (
    query?: {
    ...
    this.request<NameserviceQueryAllWhoisResponse, RpcStatus>({
      path: `/nameservice/nameservice/whois`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
