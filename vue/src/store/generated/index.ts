...
import NameserviceNameserviceNameservice from './nameservice/nameservice.nameservice'
...
export default { 
  ...
  NameserviceNameserviceNameservice: load(NameserviceNameserviceNameservice, 'nameservice.nameservice'),
